...
class helloworld_util extends EvnPluginUtil
{
  public function common_function()
  {
    return 'This string has been generated by a common function, called by "'.$this->caller->get_name().'" plugin: it\'s defined once and can be used from the normal and the autoload versions of the plugin.<br/>
More info here: <a href="http://code.google.com/p/evinrude/wiki/PluginsUtil">http://code.google.com/p/evinrude/wiki/PluginsUtil</a>.';
  }
}
?>